defmodule SkadiWeb.ServiceLiveTest do
  use SkadiWeb.ConnCase

  import Phoenix.LiveViewTest
  import Skadi.InventoryFixtures

  @create_attrs %{name: "some name", amount: "120.5", starting_date: "2026-07-19", frequency: :daily}
  @update_attrs %{name: "some updated name", amount: "456.7", starting_date: "2026-07-20", frequency: :weekly}
